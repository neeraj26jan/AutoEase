import random
import pyautogui
from main import AutomateMouseKeyboardMain, ClickType

class AutoEase(AutomateMouseKeyboardMain):
    def __init__(self):
        super().__init__()
    ...
    def scroll_to(self, element_center):
        raise NotImplementedError("Scroll functionality is not supported for the Automate class.")